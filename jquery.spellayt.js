...
(function ($) {
    ...
    $.fn.extend({
        ...
        spellayt: function (options) {
            ...
            return this.each(function (i) {
                ...
                /*****************UPDATED*******************/
                //On click on control lost and set its focus.
    ...
    $.fn.spellayt.defaults = {
        url: "dictionary.txt",
        //Default url of dictionary
        matchsentence: /[^.!?()]+/g,      //Regex to split text into sentences
        matchWord: /[a-zA-Z0-9]+/g,    //Regex to split sentences into words
    ...
    $.fn.spellayt.ignore = function () {
        ...
        if (caret != null) {
            ...
            /*****************UPDATED*******************/
            //Remove . and Spaces from last words
    ...
    var startCheck = function () {
        ...
        if (_current != null) {
            ...
            _highT = setInterval(function () { clear(); highlight(_current); }, 100);
    ...
    var showSuggestions = function (input) {
        ...
        if (caret != null) {
            ...
            /*****************UPDATED*******************/
            //Remove . and Spaces from last word.
            word = word.toString().replace(".", "");
            word = $.trim(word);
            ...
            if (suggest != null && !suggest.match && !suggest.ignore) {
                ...
                $mnu = $(menuHtml).appendTo(document.body);
    ...
    var refocus = function () {
        setTimeout(function () { _current.focus(); clear(); highlight(_current); $mnu.hide(); _current.blur(); _current.focus() }, 100);
    }
    ...
    var getCurrentWord = function () {
        ...
        if (rng.text == '.') {
            ...
            //-1 find word ahead of cursor and +2 for word behinfd cursor and space
